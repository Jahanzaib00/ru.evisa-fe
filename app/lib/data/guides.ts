...
export const ESTA_GUIDES: Guide[] = [
...

  {
    ...
    faqs: [
      ...
      {
        question:
          "Can I apply for ESTA if I was previously denied a U.S. visa?",
        answer:
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "These are third-party commercial websites that charge service fees to complete your ESTA application on your behalf. The official U.S. government fee is only $40. Third-party sites charge premium prices ($5 0-$150) for application assistance, which you do not need. Apply directly at esta.cbp.dhs.gov to pay only $40.",
      },
      {
...

  {
    ...
    faqs: [
      ...
      {
        question:
          "What if I never received a confirmation email after applying?",
        answer:
      ...
      {
        question:
          "How long does 'Authorization Pending' status typically last?",
        answer:
  ...
  // Continue with remaining core guides... (Adding key ones)
  {
    ...
    faqs: [
      ...
      {
        question:
          "Do I need to wait a certain time between U.S. visits on ESTA?",
        answer:
 ...
 */
function generateRemainingGuides(): Guide[] {
  return [
    {
      ...
      faqs: [
        ...
        {
          question:
            "How will I know when my ESTA is approved if it is pending?",
          answer:
        ...
        {
          question:
            "Can I contact CBP to check on my pending ESTA application?",
          answer:
