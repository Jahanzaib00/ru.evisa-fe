...
const mdacPersonalDetailsSchema = z.object({
...
type MDACPersonalDetailsFormData = z.infer<typeof mdacPersonalDetailsSchema>;

interface MDACPersonalDetailsStepProps {
  applicationId: string;
  onNext: () => void;
  onBack: () => void;
}

export default function MDACPersonalDetailsStep({ onNext, onBack }: MDACPersonalDetailsStepProps) {
  ...
  const { handleSubmit, setError: setFormError, control, reset, formState: { errors } } = useForm<MDACPersonalDetailsFormData>({
    resolver: zodResolver(mdacPersonalDetailsSchema),
  });
  ...
  const onSubmit = useFormSubmit(setFormError, async (data: MDACPersonalDetailsFormData) => {
