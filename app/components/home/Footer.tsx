...
const footerColumns: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { text: 'Official U.S. ESTA Site', href: 'https://esta.cbp.dhs.gov/', external: true },
      { text: 'U.S. Customs & Border', href: 'https://www.cbp.gov/', external: true },
    ],
  },
];
      ...
      <Container>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 leading-relaxed">
                Expert assistance with U.S. Electronic System for Travel Authorization applications.
        ...
        <div className="border-t border-gray-600 py-8">
          <div className="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              <strong className="text-white">This is a private service website.</strong> We are not affiliated with, endorsed by, or connected to the U.S. government or the Department of Homeland Security. The official ESTA website is{' '}
              <a
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <p className="mt-2">
              Made with care for travelers worldwide
            </p>
          </div>
        </div>
      </Container>
