...
function UsContactPage({ params }) {
    ...
    const fetchApplicationData = async ()=>{
        try {
            ...
            if (data.usPointOfContactType) {
                setValue('usPointOfContactType', data.usPointOfContactType);
                setValue('usPointOfContactName', data.usPointOfContactName);
                setValue('usContactAddressLine1', data.usContactAddressLine1);
                setValue('usContactAddressLine2', data.usContactAddressLine2 || '');
                setValue('usContactCity', data.usContactCity);
                setValue('usContactState', data.usContactState);
                setValue('usContactZipCode', data.usContactZipCode);
                setValue('usContactPhone', data.usContactPhone);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__33ec5c1e._.js.map