...
;
;
function PassportPage({ params: paramsPromise }) {
    _s();
    ...
    const fetchApplicationData = async ()=>{
        try {
            ...
            if (data.data.travelers?.length > 0) {
                setCurrentTravelerId(data.data.travelers[0].id);
                loadTravelerData(data.data.travelers[0]);
            }
        } catch (error) {
...
//# sourceMappingURL=Documents_Self%20_esta_frontend_app_e12dcf4a._.js.map