...
function FileUpload({ label, uploadType, applicationId, travelerId, currentFileUrl, onUploadComplete, accept = uploadType === 'photo' ? 'image/jpeg,image/png' : 'image/jpeg,image/png,application/pdf', helperText, error, required = false }) {
    ...
    const handleFileSelect = async (e)=>{
        ...
        try {
            ...
            const { data: presignedData } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Self__$2f$esta$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/applications/${applicationId}/uploads/presigned-url`, {
                travelerId,
                uploadType,
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Self__$2f$esta$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(uploadUrl, file, {
                headers: {
            ...
            const { data: saveData } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Self__$2f$esta$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/applications/${applicationId}/uploads/save`, {
                travelerId,
                uploadType,
                fileKey
            });
...
//# sourceMappingURL=Documents_Self%20_esta_frontend_app_3e8b23b3._.js.map