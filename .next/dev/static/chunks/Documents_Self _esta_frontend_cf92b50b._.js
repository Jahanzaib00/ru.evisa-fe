...
function FileUpload({ label, uploadType, applicationId, travelerId, currentFileUrl, onUploadComplete, accept = uploadType === 'photo' ? 'image/jpeg,image/png' : 'image/jpeg,image/png,application/pdf', helperText, error, required = false }) {
    ...
    const handleFileSelect = async (e)=>{
        ...
        try {
            ...
            const { data: presignedData } = await axios.post(`/api/applications/${applicationId}/uploads/presigned-url`, {
                travelerId,
                uploadType,
            ...
            const { data: saveData } = await axios.post(`/api/applications/${applicationId}/uploads/save`, {
                travelerId,
                uploadType,
                fileKey
            });
...
"[project]/Documents/Self /esta/frontend/app/application/[id]/documents/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DocumentsPage({ params: paramsPromise }) {
    ...
    const [uploadsComplete, setUploadsComplete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Self__$2f$esta$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
...
_s(DocumentsPage, "TWFN4PKuK1Nx6pip1TVginEUJMw=", false, function() {
    return [
...
//# sourceMappingURL=Documents_Self%20_esta_frontend_cf92b50b._.js.map